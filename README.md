...
The basic elements of a PID controller are :

* P - Proportional
* I - Integral
* D - Derivative

For this project I had to do manually tune the parameters to keep the car on track. The PID controller uses the Cross Track Error (CTE) from the system.
